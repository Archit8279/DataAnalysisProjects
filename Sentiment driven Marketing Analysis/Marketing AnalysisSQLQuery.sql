...
replace(ReviewText, '  ', ' ') as ReviewText from dbo.customer_reviews;


Select c.CustomerID, c.CustomerName, c.Email, c.Gender, c.Age, g.Country, g.City from dbo.customers c left join 
